 ...
 <div class="col-md-12">
    ...
    <div class=" col-md-1 in_1_sec">
        <div class="controls p-t-10">
               <input type="text" class="cl_id ajax_cl_id_ret_open form-control" />
    ...
    <div class=" col-md-2 in_2">
     <div class="controls p-t-10">
              <input type="text" class="soname form-control ajax_tel_ret_open valid upper" />
...
<div class="col-md-12">
    <div class="form-group col-md-8 bot_us">
        ...
        <div class="form-group col-md-4 pull-right" style="margin-top: -3px;">
            <span style="font-size: 18px; font-weight: bold;" class="dis_price" ><?=$price;?></span> <?=$valute;?>
        </div>
    </div>
...
$('.rem_plase_open_return').click(function(){
...
$('.ajax_tel_ret_open').keyup(function(){
    var Blo = $(this);
...
$('.ajax_cl_id_ret_open').keyup(function(){
            //alert('oj');
            var Blo = $(this);
            $.ajax({
                type: "POST",

...
<table width="800" border="0"  style="font-size:110%">
  <tr>
    <td width="148"><strong>REGABUS</strong></td>
    <td width="642">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"><p align="center"><div style="width: 1030px; text-align: center; padding-bottom: 20px;">"REGA & R“ spol. s r.o. Husitská 37, Praha-3 130 00 IČ 25762427, DIČ 25762427. Firma je zapsana v Obch. rejst. Městského soudu Praha oddil C, vložka 67956
</div></p></td>
  </tr>
</table>
...
<table width="800" border="0">
  <tr>
    <td width="148"><strong style="font-size:20px;">REGABUS</strong></td>
    <td width="642">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2"><div align="right"><?=__('Confirmation for operator');?></div></td>
  </tr>
  <tr>
    <td colspan="2"><p align="center"><strong><?=__('Confirmation of ticket cancellations');?></strong></p></td>
  </tr>

            ...
            <div class="row">
                <div class="col-md-12 pad_con">
                    <div class="grid simple">
                        ...
                        <h3 class="semi-bold h_ped"><?=__("Update Ost")?></h3>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="panel2-1">
                <div class="form-group">
                    ...
                    <input name="name_i18n" type="text" class="filds-ost-name name form-control"  value="<?=$edit_bus['name_i18n'];?>" placeholder="ru" />
                </div>
                <div class="form-group">
                    <label><? echo __('Description');?></label>
                    <input name="desc_i18n" type="text" class="filds-ost-desc form-control"   value="<?=$edit_bus['description_i18n'];?>" />
                </div>         
            </div>
            <div class="tab-pane" id="panel2-2">
                <div class="form-group">
                    <label><? echo __('Name');?></label>
                    <input name="name_i18n_ua" type="text" class="filds-ost-name name form-control"  value="<?=$edit_bus_ua['name_i18n'];?>"  placeholder="ua"/>
                    
                </div>
                <div class="form-group">
                    <label><? echo __('Description');?></label>
                    <input name="desc_i18n_ua" type="text" class="filds-ost-desc form-control"   value="<?=$edit_bus_ua['description_i18n'];?>" />
            ...
            <div class="tab-pane" id="panel2-3">
                <div class="form-group">
                    <label><? echo __('Name');?></label>
                    <input name="name_i18n_en" type="text" class="filds-ost-name name form-control"  value="<?=$edit_bus_en['name_i18n'];?>" placeholder="en" />
                    
                </div>
                <div class="form-group">
                    <label><? echo __('Description');?></label>
                    <input name="desc_i18n_en" type="text" class="filds-ost-desc form-control"   value="<?=$edit_bus_en['description_i18n'];?>" />
            ...
            <div class="tab-pane" id="panel2-4">
                <div class="form-group">
                    <label><? echo __('Name');?></label>
                    <input name="name_i18n_cs" type="text" class="filds-ost-name name form-control"  value="<?=$edit_bus_cs['name_i18n'];?>" placeholder="cs" />
                    
                </div>
                <div class="form-group">
                    <label><? echo __('Description');?></label>
                    <input name="desc_i18n_cs" type="text" class="filds-ost-desc form-control"   value="<?=$edit_bus_cs['description_i18n'];?>" />
            ...
            <div class="form-group">
                ...
                <select name="schema_name" class="schema_name form-control">
                    ...
                    <option value="<?=$name;?>" <?if($edit_bus['schema_name'] == $name){ echo "selected='selected'"; }?>><?=$name;?></option>
                    <?}?>
                </select>
            </div>

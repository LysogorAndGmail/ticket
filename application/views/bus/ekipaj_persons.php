                                                    ...
                                                    <tbody>
                                                      <? foreach($all as $dis){?>
                                                        <tr class="">
                                                            <td><?=$dis['id'];?></td>
                                                            <td><?=$dis['name'];?></td>
                                                            <td><? $ekip = DB::select()->from('ekipaj')->where('id','=',$dis['ekipaj_id'])->execute()->current(); echo $ekip['name'];?></td>
                                                            <td><?=$dis['persone_type'];?></td>
                                                            <td><a href="/buses/dell_ekipaj_persone?id=<?=$dis['id'];?>"><?=__('Delete');?></a></td>
                                                        </tr>
                                                    <?}?>
                                                    </tbody>
                                                  </table>

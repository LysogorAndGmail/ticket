<div class="large-3 medium-3 columns rig_bor">
    ...
    <div class="bag_blugray">
        ...
        <!--<a href="/buses" class="radius button <?if($_SERVER['REQUEST_URI'] == '/buses'){ echo 'activs';}?>"><?=__("filter");?></a>-->
        <!--
        <a href="/ferryman" class="radius button <?if($_SERVER['REQUEST_URI'] == '/ferryman'){ echo 'activs';}?>"><?=__("filter");?></a>
        <a href="/ferryman/see_all" class="radius button <?if($_SERVER['REQUEST_URI'] == '/ferryman/see_all'){ echo 'activs';}?>"><?=__("Все");?></a>
        <a href="/ferryman/add" class="radius button <?if($_SERVER['REQUEST_URI'] == '/ferryman/add'){ echo 'activs';}?>"><?=__("Добавить");?></a>

        <a href="/ferryman/see_all" class="radius button <?if($_SERVER['REQUEST_URI'] == '/ferryman/see_all'){ echo 'activs';}?>"><?=__("List ferryman");?></a>
        <a href="/buses/all_schema" class="radius button <?if($_SERVER['REQUEST_URI'] == '/buses/all_schema'){ echo 'activs';}?>"><?=__("List schems");?></a>
        <a href="/buses/see_all" class="radius button <?if($_SERVER['REQUEST_URI'] == '/buses/see_all'){ echo 'activs';}?>"><?=__("List buses");?></a>
        <a href="/buses/add" class="radius button <?if($_SERVER['REQUEST_URI'] == '/buses/add'){ echo 'activs';}?>"><?=__("Добавить");?></a>
        <a href="/buses/save_bus_schema" class="radius button <?if($_SERVER['REQUEST_URI'] == '/buses/save_bus_schema'){ echo 'activs';}?>"><?=__("Схемы транспорта");?></a>

...
<div class="content">    
  ...
  <!-- BEGIN BASIC FORM ELEMENTS-->
        ...
        <li><a href="/pages" class="link"><?=__("Pages")?></a> </li>
          <li><span href="#" class="active"><?=__("Edit Page")?></span> </li>
                  ...
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      ...
                      <div class="form-group">
                        ...
                        <div class="controls">
                <input type="text" name="alias" value="<?=$edit['slug'];?>" />
                        </div>
                      </div>
                        ...
                        <div class="controls">
                      <button class="btn btn-primary btn-cons"><?=__('Edit')?></button>
                        </div>
                      </div>

...
<div class="content">    
                ...
                <div class="update-data-ost">
                    <div class="ost_tabs">
                        <div class="u-ost-colum-a ost_ru">
                            <input type="hidden" name="join_route" value="<?=$edit['join_route'];?>" />
                            <div class="form-group">
                                <label><? echo __('Name');?></label>
                                <select name="route">
                                    <? foreach($routes as $route){?>
                                        <option value="<?=$route['svitgo_route_name_id'];?>"><?=$route['svitgo_route_name_id'];?></option>
                                    <?}?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label><? echo __('Name');?></label>
                                <input name="join_name" type="text" class="filds-ost-name name form-control"  value="<?=$edit['reg_name'];?>" />
                            </div>
                            <div class="form-group">
                                <label><? echo __('Join ost ID');?></label>
                                <input name="join_id" type="text" class="filds-ost-desc form-control"   value="<?=$edit['reg_ost_id'];?>" />
                            </div>
                            <div class="form-group">
                                <label><? echo __('Weight');?></label>
                                <input name="weight" type="text" class="filds-ost-desc form-control"   value="<?=$edit['weight'];?>" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-12 no-padding">   
        <button id="admin_login_submit" type="submit" class="btm-edit btn btn-success btn-cons"><?=__("Edit")?></button>  
    </div>
    </form>
    </div>

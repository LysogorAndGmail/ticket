...
<div class="one_people col-md-12 no-padding">  
    <div class="col-md-12">
        ...
        <div class="col-md-2 in_5">
            <div class="controls p-t-10">
            <input type="text" class="date form-control custom_date valid tip" id="date<?=$mil_sek;?>" title="format 99/99/9999" />
            </div>
        </div>
        <div class="col-md-2 in_2">
            <div class="controls p-t-10">
            <input type="text" class="tel form-control valid" value="<?=$sesuser[0]['phone_kod'];?>" maxlength="13"  />
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class=" col-md-1 no-padding in_1 text-center">
            <div class="controls p-t-10">
        ...
        <div class="form-group col-md-8 bot_us">
            &nbsp;<span style="font-weight: bold; margin-left: 7px;"><?=__('Tariff')?>:</span>&nbsp;<span class="info_discounts" ><? if(isset($all_discount_hidden[0])){ echo $all_discount_hidden[0]['name_simple_i18n'];}else{ echo $all_discount[0]['name_simple_i18n']; }?></span>
...
$('.discount').change(function(){
        ...
        $('.one_people .plase').each(function(){
            if($(this).text() == PlaseVal){
                $(this).next('.dis_price').text(NewPriceDIS.toFixed(2));
                $(this).parents('.one_people').find('.dis_price_inf').text(NewPriceDIS.toFixed(2));
            }

        ...
        <div class="col-md-6">                                  <div class="form-group">
             ...
             <div class="col-md-4">
                        <div class="form-group">
                                        ...
                                        <? foreach($cat as $c){?>
                                        <option value="<?=$c['my_post_cat_id'];?>" ><?=$c['name_i18n'];?></option>
                                        <?}?>
                                        </select>
                                        </div>       
                                        </div>
            ...
            <div class="panel panel-transparent">
                      ...
                      <div class="col-md-12">       
                        ...
                        <div class="form-group">
                                                ...
                                                <div class="controls">
                                                     <textarea name="text" placeholder="Enter text ..." class="form-control moxiecut" rows="10"></textarea>
                    ...
                    <h3><?=__("Section of the brief description of  the article")?></h3>
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                                    <label class="control-label"><?=__("Date of creating")?>
                                               ...
                                               <select class="table-group-action-input form-control input-medium" name="published_article">
                                                                           
                                                                            <option value="1"><?=__("Published")?></option>
                                                                            <option value="0"><?=__("Is not published")?></option>
                  ...
                  <div class="col-md-8">
                        ...
                        <h3><?=__("Search engine optimization section")?></h3>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="title_browser" class="form-control " value="" />

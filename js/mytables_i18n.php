<script src="<?=Kohana::$base_url?>assets/plugins/breakpoints.js" type="text/javascript"></script>
<script src="<?=Kohana::$base_url?>assets/plugins/jquery-unveil/jquery.unveil.min.js" type="text/javascript"></script>
...
<script src="<?=Kohana::$base_url?>assets/plugins/jquery-datatable/js/jquery.dataTables.js" type="text/javascript"></script>
...
<script type="text/javascript">(function(X,l,n){var L=function(h){var j=function(e){function o(a,b){var c=j.defaults.columns,d=a.aoColumns.length,c=h.extend({},j.models.oColumn,c,{sSortingClass:a.oClasses.sSortable,sSortingClassJUI:a.oClasses.sSortJUI,nTh:b?b:l.createElement("th"),sTitle:c.sTitle?c.sTitle:b?b.innerHTML:"",aDataSort:c.aDataSort?c.aDataSort:[d],mData:c.mData?c.oDefaults:d});a.aoColumns.push(c);if(a.aoPreSearchCols[d]===n||null===a.aoPreSearchCols[d])a.aoPreSearchCols[d]=h.extend({},j.models.oSearch);else if(c=a.aoPreSearchCols[d],
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"<?=__('No data available in table')?>",sInfo:"<?=__('Showing')?> _START_ <?=__('to')?> _END_ <?=__('of')?> _TOTAL_ <?=__('entries')?>",sInfoEmpty:"<?=__('Showing')?> 0 <?=__('to')?> 0 <?=__('of')?> 0 <?=__('entries')?>",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},j.models.oSearch),sAjaxDataProp:"aaData",
...
$(document).ready(function() {
    ...
    tableElement.dataTable( {
		...
		"oLanguage": {
			"sLengthMenu": "_MENU_ ",
			"sInfo": "<?=__('Showing')?> <b>_START_ <?=__('to')?> _END_</b> <?=__('of')?> _TOTAL_ <?=__('entries')?>"
		},
		 bAutoWidth     : false,
